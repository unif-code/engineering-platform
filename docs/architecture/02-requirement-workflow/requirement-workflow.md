...
Gate 以“Policy → 绑定版本的 Gate Instance → Current Assignment → Decision”表达；当前责任人可在 Decision 前按受控规则异步改派。默认责任解析、候选资格和恢复性 Override 只由[详细说明](./requirement-workflow-detail.md)定义。Agent、AI Review 和确定性检查仅提交证据，不能形成 Human Decision。
