...
export const MENU_ROWS = Object.freeze([
  ...
  createMenuRow('teamBoard', '团队看板', 5),
  createMenuRow('audit', '审计看板', 6),
  createMenuRow('admin', '管理概览', 7),
  createMenuRow('adminWorkspaces', '工作区管理', 8),
  createMenuRow('adminSkills', '技能管理', 9),
  createMenuRow('adminModels', '模型管理', 10),
  createMenuRow('adminRoles', '角色管理', 11),
  createMenuRow('adminUsers', '用户管理', 12),
  createMenuRow('adminMenus', '菜单管理', 13),
